 ...
 *
 *
 * Operation: 'analytics.management.goals.update'
 * Endpoint Path: '/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/goals/{goalId}'
 * Method: 'put'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/goals/{goalId}',
        method: 'put',
